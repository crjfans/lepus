...
<div class="control-group success">
   ...
   <div class="control-group success">
    <label class="control-label" for="">*<?php echo $this->lang->line('monitor_backups'); ?></label>
    <div class="controls">
        <select name="monitor_backups" id="monitor_backups" class="input-small">
         <option value="1" <?php echo set_selected(1,$settings['monitor_backups']) ?> ><?php echo $this->lang->line('on'); ?></option>
         <option value="0" <?php echo set_selected(0,$settings['monitor_backups']) ?> ><?php echo $this->lang->line('off'); ?></option>
        </select>
        <span class="help-inline"></span>
    </div>
   </div>
