...
<div class="well">
   ...
   <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id=""  name="ssh_user" value="<?php echo set_value('ssh_user'); ?>" >
      <span class="help-inline"></span>
    </div>
   </div>
   ...
   <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id=""  name="ssh_passwd" value="<?php echo set_value('ssh_passwd'); ?>" >
      <span class="help-inline"></span>
    </div>
   </div>
   ...
   <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id=""  name="ssh_port" value="<?php echo set_value('ssh_port','22'); ?>" >
      <span class="help-inline"></span>
    </div>
   </div>
   ...
   <hr />
    ...
    <div class="controls">
	 ...
	 &nbsp;&nbsp;<?php echo $this->lang->line('big_table_condition'); ?>&nbsp;<input type="text" id="bigtable_size" class="input-small"  name="bigtable_size" value="50" >
    </div>
    </div>
...
<div class="control-group">
    ...
    <div class="controls">
        ...
        &nbsp;&nbsp;<?php echo $this->lang->line('threshold_warning'); ?>&nbsp;<input type="text" id="threshold_warning_backup_delay" class="input-small" placeholder="" name="threshold_warning_backup_delay" value="3" >
        &nbsp;&nbsp;<?php echo $this->lang->line('threshold_critical'); ?>&nbsp;<input type="text" id="threshold_critical_backup_delay" class="input-small" placeholder="" name="threshold_critical_backup_delay" value="7" >
    </div>
    </div>
