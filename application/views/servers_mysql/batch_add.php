...
<div class="well">
   ...
   <table class="table table-hover table-bordered  ">
	<tr>
        ...
        <th colspan="7"><center><?php echo $this->lang->line('alarm_items'); ?></center></th>
	</tr>
    <tr>
        ...
        <th><?php echo $this->lang->line('db_variable'); ?><?php echo $this->lang->line('alarm'); ?></th>
	</tr>
...
<input type="hidden" name="ids[]" value="<?php echo $n ?>" /> 
    <tr style="font-size:12px;">
        ...
        <td><select name="db_variable_monitor<?php echo $n ?>"  class="input-mini">
         <option value="1"  ><?php echo $this->lang->line('on'); ?></option>
         <option value="0"  ><?php echo $this->lang->line('off'); ?></option>
        </select></td>
        ...
        <td><select name="alarm_backup_delay_<?php echo $n ?>"  class="input-mini">
         <option value="1"  ><?php echo $this->lang->line('on'); ?></option>
         <option value="0"  ><?php echo $this->lang->line('off'); ?></option>
        </select></td>
        <td><select name="alarm_db_variable_<?php echo $n ?>"  class="input-mini">
         <option value="1"  ><?php echo $this->lang->line('on'); ?></option>
         <option value="0"  ><?php echo $this->lang->line('off'); ?></option>
        </select></td>
        </td>
