...
<div class="well">
   ...
   <div class="control-group">
	...
	&nbsp;&nbsp;<?php echo $this->lang->line('big_table_condition'); ?>&nbsp;<input type="text" id="bigtable_size" class="input-small" placeholder="" name="bigtable_size" value="<?php echo $record['bigtable_size']; ?>" >
    </div>
    </div>
    ...
    <div class="control-group">
    <label class="control-label" for=""><?php echo $this->lang->line('db_variable'); ?> <?php echo $this->lang->line('monitor'); ?></label>
    <div class="controls">
        <select name="variable_monitor" id="variable_monitor" class="input-small">
         <option value="1" <?php echo set_selected(1,$record['variable_monitor']) ?> ><?php echo $this->lang->line('on'); ?></option>
         <option value="0" <?php echo set_selected(0,$record['variable_monitor']) ?> ><?php echo $this->lang->line('off'); ?></option>
        </select>
    </div>
   </div>
   ...
   <div class="control-group">
    <label class="control-label" for=""><?php echo $this->lang->line('db_variable_change'); ?> <?php echo $this->lang->line('alarm'); ?> </label>
    <div class="controls">
        <select name="alarm_variable_change" id="alarm_variable_change" class="input-small">
         <option value="1" <?php echo set_selected(1,$record['alarm_variable_change']) ?> ><?php echo $this->lang->line('on'); ?></option>
         <option value="0" <?php echo set_selected(0,$record['alarm_variable_change']) ?> ><?php echo $this->lang->line('off'); ?></option>
        </select>
    </div>
   </div>
...
<div class="control-group">
    <label class="control-label" for=""><?php echo $this->lang->line('backup'); ?> <?php echo $this->lang->line('alarm'); ?></label>
    <div class="controls">
        <select name="alarm_backup_delay" id="alarm_backup_delay" class="input-small">
         <option value="1" <?php echo set_selected(1,$record['alarm_backup_delay']) ?> ><?php echo $this->lang->line('on'); ?></option>
         <option value="0" <?php echo set_selected(0,$record['alarm_backup_delay']) ?> ><?php echo $this->lang->line('off'); ?></option>
        </select>
        &nbsp;&nbsp;<?php echo $this->lang->line('threshold_warning'); ?>&nbsp;<input type="text" id="threshold_warning_backup_delay" class="input-small" placeholder="" name="threshold_warning_backup_delay" value="<?php echo $record['threshold_warning_backup_delay']; ?>" >
        &nbsp;&nbsp;<?php echo $this->lang->line('threshold_critical'); ?>&nbsp;<input type="text" id="threshold_critical_backup_delay" class="input-small" placeholder="" name="threshold_critical_backup_delay" value="<?php echo $record['threshold_critical_backup_delay']; ?>" >
    </div>
    </div>
