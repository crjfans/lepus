...
spin_waits, spin_rounds, os_waits, rows_inserted, rows_updated, rows_deleted, rows_read, Table_locks_waited, Table_locks_immediate, Slow_queries, Open_files, 
Open_tables, Opened_tables, innodb_open_files, open_files_limit, table_cache, Aborted_clients, Aborted_connects, Max_used_connections, Slow_launch_threads, 
Threads_cached, Threads_connected, Threads_created, Threads_running, max_connections, thread_cache_size, Connections, slave_running, slave_stopped, 
Slave_retried_transactions, slave_lag, Slave_open_temp_tables, Qcache_free_blocks, Qcache_free_memory, Qcache_hits, Qcache_inserts, Qcache_lowmem_prunes, 
Qcache_not_cached, Qcache_queries_in_cache, Qcache_total_blocks, query_cache_size, Questions, Com_update, Com_insert, Com_select, Com_delete, Com_replace, 
Com_load, Com_update_multi, Com_insert_select, Com_delete_multi, Com_replace_select, Select_full_join, Select_full_range_join, Select_range, 
Select_range_check, Select_scan, Sort_merge_passes, Sort_range, Sort_rows, Sort_scan, Created_tmp_tables, Created_tmp_disk_tables, Created_tmp_files, 
Bytes_sent, Bytes_received, innodb_log_buffer_size, unflushed_log, log_bytes_flushed, log_bytes_written, relay_log_space, binlog_cache_size, 
Binlog_cache_disk_use, Binlog_cache_use, binary_log_space, innodb_locked_tables, innodb_lock_structs, State_closing_tables, State_copying_to_tmp_table, 
State_end, State_freeing_items, State_init, State_locked, State_login, State_preparing, State_reading_from_net, State_sending_data, State_sorting_result, 
State_statistics, State_updating, State_writing_to_net, State_none, State_other, Handler_commit, Handler_delete, Handler_discover, Handler_prepare, 
Handler_read_first, Handler_read_key, Handler_read_next, Handler_read_prev, Handler_read_rnd, Handler_read_rnd_next, Handler_rollback, Handler_savepobigint, 
Handler_savepobigint_rollback, Handler_update, Handler_write, innodb_tables_in_use, innodb_lock_wait_secs, hash_index_cells_total, hash_index_cells_used, 
total_mem_alloc, additional_pool_alloc, uncheckpobiginted_bytes, ibuf_used_cells, ibuf_free_cells, ibuf_cell_count, adaptive_hash_memory, page_hash_memory, 
dictionary_cache_memory, file_system_memory, lock_system_memory, recovery_system_memory, thread_hash_memory, innodb_sem_waits, innodb_sem_wait_time_ms, 
Key_buf_bytes_unflushed, Key_buf_bytes_used, key_buffer_size, Innodb_row_lock_time, Innodb_row_lock_waits, Query_time_count_00, Query_time_count_01, 
Query_time_count_02, Query_time_count_03, Query_time_count_04, Query_time_count_05, Query_time_count_06, Query_time_count_07, Query_time_count_08, 
Query_time_count_09, Query_time_count_10, Query_time_count_11, Query_time_count_12, Query_time_count_13, Query_time_total_00, Query_time_total_01, 
Query_time_total_02, Query_time_total_03, Query_time_total_04, Query_time_total_05, Query_time_total_06, Query_time_total_07, Query_time_total_08, 
